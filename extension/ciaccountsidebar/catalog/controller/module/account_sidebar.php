<?php
namespace Opencart\Catalog\Controller\Extension\Ciaccountsidebar\Module;
class AccountSidebar extends \Opencart\System\Engine\Controller {
	...
	public function index() {
		...
		$this->document->addStyle(HTTP_SERVER . 'extension/ciaccountsidebar/catalog/view/stylesheet/accountdashboard/sidebar.css');
		...
		if($data['main_links']) {
			return $this->load->view('extension/ciaccountsidebar/module/account_sidebar', $data);
		}
	}
