...
$_['module_account_sidebar_title'][0]['link_title'][0]['iconclass'] = 'fa-user-check';
...
$_['module_account_sidebar_title'][0]['link_title'][2]['iconclass'] = 'fa-house-user';
...
$_['module_account_sidebar_title'][0]['link_title'][3]['iconclass'] = 'fa-pen-to-square';
...
$_['module_account_sidebar_title'][1]['link_title'][2]['iconclass'] = 'fa-exchange-alt';
...
$_['module_account_sidebar_title'][1]['link_title'][3]['iconclass'] = 'fa-money-bill';
...
$_['module_account_sidebar_title'][2]['link_title'][0]['iconclass'] = 'fa-sign-out-alt';
